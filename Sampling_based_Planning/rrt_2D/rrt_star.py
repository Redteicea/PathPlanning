...
from Sampling_based_Planning.rrt_2D import env, plotting, utils, planning_queue
    ...
    def planning(self):
        for k in range(self.iter_max):
            ...
            if node_new and not self.utils.is_collision(node_near, node_new):
                ...
                if neighbor_index:
                    # 从近邻节点中选择路径代价更小的作为新节点的父节点
                    self.choose_parent(node_new, neighbor_index)
                    # 对近邻节点（不包含新节点的父节点）重新检查是否存在更优的路径
